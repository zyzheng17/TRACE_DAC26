...
def parse_args():
    parser = argparse.ArgumentParser(description='Train TRACE on PM netlist contrastive pairs.')
    parser.add_argument('--data_path', type=Path, default=Path('../../../../data/pm_netlist/forgeeda_pm_pair_pkl'),
